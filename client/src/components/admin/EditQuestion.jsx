    ...
    <>
      <form method="post" onSubmit={handleUpdateQuestion}>
        ...
        <input
          ...
          onChange={e => question.setParam1(e.target.value)}
        />
        <input
          type="number"
          min="0"
          ...
          onChange={e => question.setParam2(e.target.value)}
        />
        <input
          type="number"
          min="0"
          ...
          onChange={e => question.setParam3(e.target.value)}
        />
        <input
          type="number"
          min="0"
          ...
          onChange={e => question.setParam4(e.target.value)}
        />
        <input
          type="number"
          min="0"
