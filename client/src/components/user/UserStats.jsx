    ...
    const f = async () => {
      ...
      if(answers && questions){
        answers.forEach(answer => {
          ...
          setParam1((parameterArray[0])/answerCount);
          setParam2((parameterArray[1])/answerCount);
          setParam3((parameterArray[2])/answerCount);
          setParam4((parameterArray[3])/answerCount);
          setParam5((parameterArray[4])/answerCount);
        });
      }
      setLoaded(true);
    }
...
export default inject(`characterStore`, `questionStore`, `answerStore`)(
