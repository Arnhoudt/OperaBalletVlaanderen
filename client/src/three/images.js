...
import {BACKGROUND_COLORS, FONTS, HOME_IMAGE_SIZE_LARGER, HOME_IMAGE_SIZE, WORLD_POSITION, SHOWROOM_MAX_X_ROTATION,SHOWROOM_MAX_Y_ROTATION,SHOWROOM_MAX_Z_ROTATION} from "../constants";
...
class Images {
  ...
  load = that => {
    ...
    //CREATE IMAGES
    this.canary.createImage(that, `assets/img/jouwKarakter1.png`, 300, 150, WORLD_POSITION.images - 800, 1920/HOME_IMAGE_SIZE, 1080/HOME_IMAGE_SIZE, `showRoomImage`);
    this.canary.createImage(that, `assets/img/jouwKarakter2.png`, -250, -100, WORLD_POSITION.images - 1200, 1920/HOME_IMAGE_SIZE, 1080/HOME_IMAGE_SIZE, `showRoomImage`);
    this.canary.createImage(that, `assets/img/jouwKarakter3.png`, 200, 0, WORLD_POSITION.images - 1600, 1920/HOME_IMAGE_SIZE, 1080/HOME_IMAGE_SIZE, `showRoomImage`);
    this.canary.createImage(that, `assets/img/jouwKarakter4.png`, -200, 200, WORLD_POSITION.images - 2000, 1920/HOME_IMAGE_SIZE, 1080/HOME_IMAGE_SIZE, `showRoomImage`);
    this.canary.createImage(that, `assets/img/jouwKarakter5.png`, 0, 0, WORLD_POSITION.images - 2500, 1920/HOME_IMAGE_SIZE, 1080/HOME_IMAGE_SIZE, `showRoomImage`);
    //CREATE TEXT
